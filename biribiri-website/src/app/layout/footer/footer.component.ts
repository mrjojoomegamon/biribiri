    ...
    <footer class="bg-bg-secondary border-t border-border">
      <div class="max-w-container mx-auto px-4 py-12">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <!-- Quick Links -->
          <div>
            <h4 class="text-lg font-bold uppercase tracking-wider text-text-primary mb-4">
              NAVEGACIÓN
            </h4>
            <ul class="space-y-2">
              <li>
                <a routerLink="/" class="text-text-secondary hover:text-accent transition-colors">
                  Inicio
                </a>
              </li>
              <li>
                <a routerLink="/servicios" class="text-text-secondary hover:text-accent transition-colors">
                  Servicios
                </a>
              </li>
              <li>
                <a routerLink="/suplementos" class="text-text-secondary hover:text-accent transition-colors">
                  Suplementos
                </a>
              </li>
              <li>
                <a routerLink="/sobre-mi" class="text-text-secondary hover:text-accent transition-colors">
                  Sobre Mí
                </a>
              </li>
              <li>
                <a routerLink="/contacto" class="text-text-secondary hover:text-accent transition-colors">
                  Contacto
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <div class="space-y-3">
              <div class="flex items-center space-x-3">
                ...
                <span class="text-text-secondary">+52 55 7426 4946</span>
              </div>
              <div class="flex items-center space-x-3">
                <svg class="w-5 h-5 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
                </svg>
                <span class="text-text-secondary">laestrellarichard@gmail.com</span>
              </div>
        ...
        <div class="border-t border-border mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p class="text-text-secondary text-sm">
            © 2025 BIRIBIRI. Todos los derechos reservados.
          </p>
